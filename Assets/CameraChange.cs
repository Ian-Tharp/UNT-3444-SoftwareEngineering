...
public class CameraChange : MonoBehaviour
{
    ...
    public Vector3 center; //center between two objects
    ...
    public int MAX, MIN; //max and min of camera size
    ...
    void FixedUpdate()
    {
        center = ((reticle.position - player.position)/2.0f) + player.position; //center calc
        ...
        {
            shakeTime = 0.2f;
            shakeMag = .05f * sg.recoilBuildup + .1f;
        }
    }
}
